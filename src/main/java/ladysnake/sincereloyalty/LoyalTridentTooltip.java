...
public final class LoyalTridentTooltip {
    ...
    public static void register() {
        ItemTooltipCallback.EVENT.register(LoyalTridentTooltip::appendOwnedByTooltip);
    }

    private static void appendOwnedByTooltip(ItemStack stack, Item.TooltipContext tooltipContext, TooltipType tooltipType, List<Text> lines) {
